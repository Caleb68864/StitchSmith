        ...
        paths: [
          {
            ...
            closed: true,
            edges: [
              { kind: 'straight', id: 'fp-e0', role: 'cut', start: { x: 0, y: 0 }, end: { x: 300, y: 0 } },
              { kind: 'straight', id: 'fp-e1', role: 'cut', start: { x: 300, y: 0 }, end: { x: 300, y: 400 } },
              { kind: 'straight', id: 'fp-e2', role: 'cut', start: { x: 300, y: 400 }, end: { x: 0, y: 400 } },
              { kind: 'straight', id: 'fp-e3', role: 'cut', start: { x: 0, y: 400 }, end: { x: 0, y: 0 } },
            ],
          },
        ],
      },
        ...
        paths: [
          {
            ...
            closed: true,
            edges: [
              { kind: 'straight', id: 'bp-e0', role: 'cut', start: { x: 0, y: 0 }, end: { x: 300, y: 0 } },
              { kind: 'straight', id: 'bp-e1', role: 'cut', start: { x: 300, y: 0 }, end: { x: 300, y: 400 } },
              { kind: 'straight', id: 'bp-e2', role: 'cut', start: { x: 300, y: 400 }, end: { x: 0, y: 0 } },
            ],
          },
        ],
      },
        ...
        paths: [
          {
            ...
            closed: true,
            edges: [
              { kind: 'straight', id: 'zp-e0', role: 'cut', start: { x: 0, y: 0 }, end: { x: 150, y: 0 } },
              { kind: 'straight', id: 'zp-e1', role: 'cut', start: { x: 150, y: 0 }, end: { x: 150, y: 200 } },
              { kind: 'straight', id: 'zp-e2', role: 'cut', start: { x: 150, y: 200 }, end: { x: 0, y: 0 } },
            ],
          },
        ],
      },
          ...
          paths: [
            {
              ...
              closed: true,
              edges: [
                { kind: 'straight', id: 'px-e0', role: 'cut', start: { x: 0, y: 0 }, end: { x: 50, y: 0 } },
                { kind: 'straight', id: 'px-e1', role: 'cut', start: { x: 50, y: 0 }, end: { x: 50, y: 50 } },
                { kind: 'straight', id: 'px-e2', role: 'cut', start: { x: 50, y: 50 }, end: { x: 0, y: 0 } },
              ],
            },
          ],
        },
