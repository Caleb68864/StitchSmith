    ...
    paths: [
      {
        ...
        closed: true,
        edges: [
          { kind: 'straight', role: 'cut', start: { x: 0, y: 0 }, end: { x: size, y: 0 } },
          { kind: 'straight', role: 'cut', start: { x: size, y: 0 }, end: { x: size, y: size } },
          { kind: 'straight', role: 'cut', start: { x: size, y: size }, end: { x: 0, y: size } },
          { kind: 'straight', role: 'cut', start: { x: 0, y: size }, end: { x: 0, y: 0 } },
        ],
      },
    ],
  };
