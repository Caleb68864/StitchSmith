...
export function buildLaptopSleeve(r: ResolvedInputs): ModuleResult {
  ...
  const panelPath: Path = {
    ...
    edges: [
      seg(0, 0, SLEEVE_WIDTH, 0),
      seg(SLEEVE_WIDTH, 0, SLEEVE_WIDTH, SLEEVE_HEIGHT),
      seg(SLEEVE_WIDTH, SLEEVE_HEIGHT, 0, SLEEVE_HEIGHT),
      seg(0, SLEEVE_HEIGHT, 0, 0),
    ],
    closed: true,
  };
  ...
  const gussetPath: Path = {
    ...
    edges: [
      seg(0, 0, SLEEVE_DEPTH, 0),
      seg(SLEEVE_DEPTH, 0, SLEEVE_DEPTH, SLEEVE_HEIGHT * 2 + SLEEVE_WIDTH),
      seg(SLEEVE_DEPTH, SLEEVE_HEIGHT * 2 + SLEEVE_WIDTH, 0, SLEEVE_HEIGHT * 2 + SLEEVE_WIDTH),
      seg(0, SLEEVE_HEIGHT * 2 + SLEEVE_WIDTH, 0, 0),
    ],
    closed: true,
  };
